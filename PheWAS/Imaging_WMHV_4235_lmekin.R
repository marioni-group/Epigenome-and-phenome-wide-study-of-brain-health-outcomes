...
write.csv(prot, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/Interpretation/prot_file_110821_WMHV.csv", row.names = F)
...
# Run WMHV - without ICV 

length <- 4235
phenotype <- c("WMH_Volume_Total")

prot$WMH_Volume_Total <- as.numeric(prot$WMH_Volume_Total)
...
for (j in 1:length(phenotype)){
  ...
  for(i in 1:1000){
    tryCatch({ 
      ...
      mod <- lmekin(scale(prot[,prot_name]) ~ scale(prot$st_age) + as.factor(prot$sex) + scale(prot[,pheno]) + as.factor(prot$combined) + (1|prot$id), na.action = na.exclude, data = prot, varlist = kin_model*2)
  ...
  write.csv(results, paste0("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/pheWAS/pheWAS_WMHV_110821/WMHV_no_ICV_result_b1.csv"))
}
...
for (j in 1:length(phenotype)){
  ...
  write.csv(results, paste0("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/pheWAS/pheWAS_WMHV_110821/WMHV_no_ICV_result_b2.csv"))
}
...
for (j in 1:length(phenotype)){
  ...
  write.csv(results, paste0("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/pheWAS/pheWAS_WMHV_110821/WMHV_no_ICV_result_b3.csv"))
}
...
for (j in 1:length(phenotype)){
  ...
  write.csv(results, paste0("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/pheWAS/pheWAS_WMHV_110821/WMHV_no_ICV_result_b4.csv"))
}


# Join together 
b1 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/pheWAS/pheWAS_WMHV_110821/WMHV_no_ICV_result_b1.csv")
b2 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/pheWAS/pheWAS_WMHV_110821/WMHV_no_ICV_result_b2.csv")
b3 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/pheWAS/pheWAS_WMHV_110821/WMHV_no_ICV_result_b3.csv")
b4 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/pheWAS/pheWAS_WMHV_110821/WMHV_no_ICV_result_b4.csv")
...
results <- rbind(b1,b2)
results <- rbind(results,b3)
results <- rbind(results,b4)
  ...
  write.csv(joint, paste0("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/pheWAS/pheWAS_WMHV_110821/WMHV_annotated_FDR.csv"), row.names = F)
...
names(WBV) <- c("SeqId", "Phenotype 5", "n", "Beta", "SE", "P", "FDR P")
...
write.csv(join, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/pheWAS/pheWAS_070621_all/imaging_results_annotated/IM_joint_suppl_table.csv", row.names = F)
