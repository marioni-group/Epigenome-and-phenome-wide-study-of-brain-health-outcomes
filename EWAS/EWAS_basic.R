...
# # check meth residualisation 
# meth2 <- meth 
# meth2 <- as.data.frame(meth2)
# meth2_sub <- meth2[,c(1:5)]
# meth <- meth2_sub
...
# Check to make sure IDs and order is correct across matching 
# test3 <- tmp[c(1:3)]
...
fwrite(tmp, file="/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/methylation_778_meth_order_basic_240521.txt", row.names=F, quote = F, sep=' ')

# Save order of IDs from the methylation file 
test3 <- tmp[c(1:3)]
write.csv(test3, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/record_of_IDS_for_methylation_778_meth_order_basic_240521_v2.csv")

# Save methylation file for reference
...
order <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/record_of_IDS_for_methylation_778_meth_order_basic_240521_v2.csv")
# o <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/record_of_IDS_for_methylation_778_meth_order_basic_240521.csv")
...
location <- "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/"
...
# Previous ewas pheno files are compromised - note as a reminder from this script (run 240521)
...
osca_Linux --efile /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/methylation_778_meth_order_basic_240521.txt --methylation-m --make-bod --out /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/methylation_778_meth_order_basic_240521
...
opi1 = read.table("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/methylation_778_meth_order_basic_240521.opi", header=F, stringsAsFactors=F)
...
write.table(opi, file="/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/methylation_778_meth_order_basic_240521.opi",  # make sure to keep the same filename as before
                col.names=F, 
                row.names=F, 
                quote=F, sep='\t')

head /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/methylation_778_meth_order_basic_240521.opi
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch1/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch2/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch3/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch4/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch5/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch6/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch7/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch8/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch9/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch10/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch11/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch12/
for i in *.phen 
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch1/")

sig_hits <- "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/sig_hits/"
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch2/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch3/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch4/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch5/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch6/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch7/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch8/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch9/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch10/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch11/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/batch12/")
...
# > dim(osca)
# [1] 376783     - number of basic pQTMs 

length(unique(osca$SeqId))

# [1] 605 proteins with signals 
...
# Save 
write.csv(comb2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_240521_results/no_eGFR_basic_EWAS_thr_3_6.csv", row.names = F)

# Filter down to p value adjusted cut off of 3.6 x 10 - 8 / 4235 = 8.50059e-12 

# > 0.000000036 / 4235
# [1] 8.50059e-12

# 0.0000000000085005903

comb2_filt <- comb2[which(comb2$p < 0.0000000000085005903),]

# # Save 
# write.csv(comb2_filt, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_240521_results/no_eGFR_basic_EWAS_thr_divided.csv", row.names = F)
...
comb2_filt2 <- comb2[which(comb2$p < 0.00000000001528098),]

# Save 
write.csv(comb2_filt2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_240521_results/no_eGFR_basic_EWAS_thr_bonfer.csv", row.names = F)

# I will use the latter as the correction threshold for now 

# Order and save an ordered version
 comb23 <- comb2_filt2[order(comb2_filt2$p),]

 write.csv(comb23, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_240521_results/no_eGFR_basic_EWAS_thr_bonfer_ordered.csv", row.names = F)




# See how many assocs we now have in total 

dim(comb2) # 376783   - at EWAS 3.6x10-8 significance 

dim(comb2_filt2) # 133617 - update to 131691  - at cpg/protein adjusted significance 

# Work out possible associations 

# 4235 x 772619 = 3272041465

# (131691 / 3272041465) * 100, is 0.004% of possible associations 
